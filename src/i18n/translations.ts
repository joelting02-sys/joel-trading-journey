...
export const translations = {
  en: {
    ...
    accountsPage: {
      ...
      bindSopSet: "Bind SOP Set",
      bindSopSetHint: "Override global active SOP for this account",
      noBind: "Use global active",
    },
    // Settings page
    settingsPage: {
    ...
    sopPage: {
      ...
      deleteSetConfirm: "Delete this SOP set? Rules in it will be lost.",
      newSetName: "SOP Set Name",
      newSetNamePlaceholder: "e.g. Intraday SOP",
      noDeleteDefault: "Cannot delete the default SOP set.",
      bindSopSet: "Bind SOP Set",
      bindSopSetHint: "Override global active SOP for this account",
      noBind: "Use global active",
    },
  ...
  zh: {
    ...
    accountsPage: {
      ...
      startDate: "开始日期",
      bindSopSet: "绑定 SOP 集",
      bindSopSetHint: "为此账户覆盖全局选中的 SOP 集",
      noBind: "使用全局选中",
    },
    settingsPage: {
      preferences: "偏好设置",
    ...
    sopPage: {
      ...
      renameSet: "重命名",
      deleteSet: "删除集",
      deleteSetConfirm: "确定删除此 SOP 集？里面的规则将全部丢失。",
      newSetName: "SOP 集名称",
      newSetNamePlaceholder: "如：日内交易 SOP",
      noDeleteDefault: "默认 SOP 集不可删除。",
      bindSopSet: "绑定 SOP 集",
      bindSopSetHint: "为此账户覆盖全局选中的 SOP 集",
      noBind: "使用全局选中",
    },
